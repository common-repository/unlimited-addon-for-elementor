 ...
 * @since 1.0.0
 */
class uae_addon_card extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Card', 'unlimited-addon' );
	}
	...
	<?php
      ...
      case 'style3': ?>	
		...
		<div class="card-body">
			...
			<p class="card-text"><?php echo wp_kses_post($settings['description']); ?></p>
			<!-- Link -->
			<a href="<?php echo esc_url($settings['button_url']['url']); ?>" class="black-text d-flex justify-content-end uae-icon-area">
