...
class uae_Clock_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( "Clock", 'unlimited-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'clock_format', [
			'label'     => esc_html__( 'Clock Format', 'unlimited-addon' ),
			'type'      => \Elementor\Controls_Manager::SELECT,
			'options'   => [
				'12' => esc_html__( '12 Hour', 'unlimited-addon' ),
				'24' => esc_html__( '24 Hour', 'unlimited-addon' ),
			],
			'default'   => '12',
		] );
