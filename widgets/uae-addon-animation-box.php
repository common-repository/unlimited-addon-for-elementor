 ...
 * @since 1.0.0
 */
class uae_addon_animation_box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Animation Box', 'unlimited-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}:hover .ts-iconbox.ts-style1' => 'background: {{VALUE}}',
				],
			]
		);
	...
	?>
	<div class="ts-iconbox ts-style1 <?php echo esc_attr($settings['display_alignment']); ?>">
